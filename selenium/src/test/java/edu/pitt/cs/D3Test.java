...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    driver.manage().window().setSize(new Dimension(1157, 691));
    {
  ...
  @Test
  public void dEFECT2FUNGREETACATSINGLERENTED() {
    driver.get("http://localhost:8080/");
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    driver.manage().window().setSize(new Dimension(1157, 691));
  ...
  @Test
  public void dEFECT3FUNGREETACATRENTED() {
    driver.get("http://localhost:8080/");
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    driver.manage().window().setSize(new Dimension(1157, 691));
    js.executeScript("document.cookie = \"1=true\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
  ...
  public void tEST4LISTING() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[@id=\'listing\']/ul/li[0]"));
      assert(elements.size() == 0);
    }
    //driver.close();
  }
